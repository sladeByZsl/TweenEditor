...
namespace DG.Tweening
{
	public class TweenParams
	{
		...
		public TweenParams Clear()
		{
			...
			this.onStart = this.onPlay = this.onRewind = this.onUpdate = this.onStepComplete = this.onComplete = (TweenCallback) (this.onKill = null);
		...
		public TweenParams SetLoops(int loops, LoopType? loopType)
		{
			if (loops < -1)
			{
				loops = -1;
