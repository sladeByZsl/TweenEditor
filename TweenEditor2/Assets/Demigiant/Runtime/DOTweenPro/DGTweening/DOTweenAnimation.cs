...
namespace DG.Tweening
{
    ...
    public class DOTweenAnimation : ABSAnimationComponent
    {
        ...
        private static Vector3[] GetBeizerList(Vector3 startPoint, Vector3 ctrlPt1, Vector3 ctrlPt2, Vector3 endPoint, int segmentNum)
        {
        ...
        public bool same_P1;
        public Vector2 P1_Offset;
        public Vector2 P1_RandomRange;
        public Vector2 P2_Offset;
		public bool useScal;
		public Vector2 P1_Scal;
		public Vector2 P2_Scal;
		public Vector2 End_Scal;
        ...
        public override void DORestart(bool fromHere = false)
        {
			...
			DOTween.Restart(this.gameObject,fromHere);
        }
        ...
        {
            _playCount = -1;
			DOTween.Restart(this.gameObject, id,false);
        }
        public void DORestartAllById(string id)
        {
            _playCount = -1;
            DOTween.Restart(id, false);
        }
