...
namespace DG.DOTweenEditor
{
    ...
    public class DOTweenAnimationInspector : ABSAnimationInspector
    {
        ...
        static readonly Dictionary<DOTweenAnimationType, Type[]> _AnimationTypeToComponent = new Dictionary<DOTweenAnimationType, Type[]>() {
            ...
            { DOTweenAnimationType.BezierMove, new[] { typeof(Rigidbody), typeof(Rigidbody2D), typeof(RectTransform), typeof(Transform) } },
...
//                _src.animationType = (DOTweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
            ...
            if (_src.animationType == DOTweenAnimationType.BezierMove)
            {
				_src.P1_Offset = EditorGUILayout.Vector2Field("P1 Offset", _src.P1_Offset, GUILayout.Height(16));  
				_src.same_P1 = EditorGUILayout.Toggle("    P2 Same P1", _src.same_P1);
				_src.useRandomRange = EditorGUILayout.Toggle("    useRandomRange", _src.useRandomRange);
				if (_src.useRandomRange) 
				{
					_src.P1_RandomRange = EditorGUILayout.Vector2Field(new GUIContent("Random Range", "Random Range of CtrlPt1 X  Y"), _src.P1_RandomRange, GUILayout.Height(16) );
				}
				_src.P2_Offset = EditorGUILayout.Vector2Field("P2 Offset", _src.P2_Offset, GUILayout.Height(16));
				_src.useScal = EditorGUILayout.Toggle("    useScal", _src.useScal);
				if (_src.useScal) 
				{
					_src.P1_Scal = EditorGUILayout.Vector2Field(new GUIContent("P1 Scal", "P1 Scal of P1 scal  timer"), _src.P1_Scal, GUILayout.Height(16) );
					_src.P2_Scal = EditorGUILayout.Vector2Field(new GUIContent("P2 Scal", "P1 Scal of P2 scal  timer"), _src.P2_Scal, GUILayout.Height(16) );
					_src.End_Scal = EditorGUILayout.Vector2Field(new GUIContent("End Scal", "P1 Scal of End scal  timer"), _src.End_Scal, GUILayout.Height(16) );
				}
            ...
            case DOTweenAnimationType.LocalMove:
            case DOTweenAnimationType.BezierMove:
                bool isEnd = _src.animationType != DOTweenAnimationType.Move;
                GUIEndValueV3(isEnd);
